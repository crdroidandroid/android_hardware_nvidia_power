...
include $(CLEAR_VARS)
LOCAL_MODULE := android.hardware.power-service-nvidia
LOCAL_INIT_RC := android.hardware.power-service-nvidia.rc
LOCAL_VINTF_FRAGMENTS := android.hardware.power-service-nvidia.xml
